...
import com.zwm.oj.config.WxOpenConfig;
...
import com.zwm.oj.model.dto.user.UserAddRequest;
import com.zwm.oj.model.dto.user.UserLoginRequest;
import com.zwm.oj.model.dto.user.UserQueryRequest;
import com.zwm.oj.model.dto.user.UserRegisterRequest;
import com.zwm.oj.model.dto.user.UserUpdateMyRequest;
import com.zwm.oj.model.dto.user.UserUpdateRequest;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        if (StringUtils.isAnyBlank(userAccount, userPassword, checkPassword, userAvatar,userName)) {
            return null;
        }
        long result = userService.userRegister(userAvatar,userName,userAccount, userPassword, checkPassword);
