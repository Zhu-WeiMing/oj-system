...
import {BaseResponse_QuestionSubmit_} from "../models/BaseResponse_QuestionSubmit_";
...
export class QuestionControllerService {
    ...
    public static getfinishQuestionDetail(
        id: number
    ): CancelablePromise<BaseResponse_QuestionSubmit_> {
        return __request(OpenAPI, {
            method: "GET",
            url: "/api/question/getfinishQuestionDetail",
            query: {
                "id": id
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static listLatestByUserId(
        id?: number
    ): any {
        return __request(OpenAPI, {
            method: "GET",
            url: "/api/question/question_submit/my/latestByUserId",
            query: {
                "id": id
            },
            errors: {
